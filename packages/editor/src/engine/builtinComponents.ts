...
const HEADING_META: ComponentMeta = {
  type: 'Heading',
  label: '标题',
  icon: 'hash',
  category: 'basic',
...
const BADGE_META: ComponentMeta = {
  type: 'Badge',
  label: '徽章',
  icon: 'tag',
  category: 'basic',
...
const SPACER_META: ComponentMeta = {
  type: 'Spacer',
  label: '间距块',
  icon: 'spacer',
  category: 'basic',
...
const SECTION_META: ComponentMeta = {
  type: 'Section',
  label: '区块',
  icon: 'section',
  category: 'layout',
...
const COLUMNS_META: ComponentMeta = {
  type: 'Columns',
  label: '多列',
  icon: 'columns',
  category: 'layout',
...
const ABSOLUTE_BOX_META: ComponentMeta = {
  type: 'AbsoluteBox',
  label: '自由层',
  icon: 'layers',
  category: 'layout',
...
const INPUT_FIELD_META: ComponentMeta = {
  type: 'InputField',
  label: '输入框',
  icon: 'input',
  category: 'form',
...
const TEXTAREA_FIELD_META: ComponentMeta = {
  type: 'TextareaField',
  label: '多行输入',
  icon: 'textarea',
  category: 'form',
...
const CHECKBOX_META: ComponentMeta = {
  type: 'Checkbox',
  label: '复选框',
  icon: 'check',
  category: 'form',
...
const SELECT_FIELD_META: ComponentMeta = {
  type: 'SelectField',
  label: '下拉选择',
  icon: 'select',
  category: 'form',
...
const VIDEO_META: ComponentMeta = {
  type: 'Video',
  label: '视频',
  icon: 'video',
  category: 'media',
...
const HEADER_META: ComponentMeta = {
  type: 'Header',
  label: '页面头部',
  icon: 'layout',
  category: 'layout',
...
const FOOTER_META: ComponentMeta = {
  type: 'Footer',
  label: '页脚',
  icon: 'layout',
  category: 'layout',
...
const ALERT_META: ComponentMeta = {
  type: 'Alert',
  label: '提示框',
  icon: 'info',
  category: 'basic',
...
const AVATAR_META: ComponentMeta = {
  type: 'Avatar',
  label: '头像',
  icon: 'user',
  category: 'basic',
...
const MENU_ITEM_META: ComponentMeta = {
  type: 'MenuItem',
  label: '菜单项',
  icon: 'link',
  category: 'layout',
...
const DROPDOWN_META: ComponentMeta = {
  type: 'Dropdown',
  label: '下拉菜单',
  icon: 'chevron-down',
  category: 'layout',
...
const CAROUSEL_META: ComponentMeta = {
  type: 'Carousel',
  label: '轮播',
  icon: 'image',
  category: 'advanced',
...
const CAROUSEL_ITEM_META: ComponentMeta = {
  type: 'CarouselItem',
  label: '轮播项',
  icon: 'image',
  category: 'advanced',
...
const FLOATING_BUTTON_META: ComponentMeta = {
  type: 'FloatingButton',
  label: '浮动按钮',
  icon: 'circle',
  category: 'advanced',
