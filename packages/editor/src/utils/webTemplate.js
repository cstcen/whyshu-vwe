...
function convertElement(el, baseUrl) {
...
function htmlToSchema(url, html) {
...
function collectSameOriginLinks(baseUrl, html) {
...
export async function crawlWebsiteAsTemplatePack(entryUrl, depth = 1) {
